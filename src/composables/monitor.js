import {
  ...
  export function useMonitor() {
    ...
    const footer =  shallowRef(
      defineAsyncComponent(() => import('../components/RodaPeXs.vue')),
    );
    ...
    const updateBreakpoint = () => {
      ...
      if (width < 576) {
        ...
        footer.value = defineAsyncComponent(() =>
          import('../components/RodaPeXs.vue'),
        );
      } else if (width < 768) {
        breakpoint.value = 'sm';
        menu.value = defineAsyncComponent(() =>
        ...
        footer.value = defineAsyncComponent(() =>
          import('../components/RodaPeSm.vue'),
        );
      } else if (width < 992) {
        breakpoint.value = 'md';
        menu.value = defineAsyncComponent(() =>
        ...
        footer.value = defineAsyncComponent(() =>
          import('../components/RodaPeMd.vue'),
        );
      } else if (width < 1200) {
        breakpoint.value = 'lg';
        menu.value = defineAsyncComponent(() =>
        ...
        footer.value = defineAsyncComponent(() =>
          import('../components/RodaPeLg.vue'),
        );
      } else {
        breakpoint.value = 'xl';
        menu.value = defineAsyncComponent(() =>
        ...
        footer.value = defineAsyncComponent(() =>
          import('../components/RodaPeXl.vue'),
        );
      }
    };
